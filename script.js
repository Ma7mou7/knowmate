...
const qs=[
["What's your favorite food?","ما أكلك المفضل؟","FOOD","طعام"],["What do you dream of becoming?","ما الوظيفة التي تحلم بها؟","GOALS","أهداف"],["What's your favorite game?","ما لعبتك المفضلة؟","FAVORITES","مفضلات"],["Where do you most want to travel?","أين تتمنى أن تسافر؟","TRAVEL","سفر"],["What instantly makes you happy?","ما الشيء الذي يسعدك فورًا؟","PERSONALITY","شخصية"],["What's your favorite movie or show?","ما فيلمك أو مسلسلك المفضل؟","FAVORITES","مفضلات"],["What's your biggest goal right now?","ما أكبر هدف لك حاليًا؟","GOALS","أهداف"],["What could you never live without?","ما الشيء الذي لا تستطيع العيش بدونه؟","LIFESTYLE","أسلوب حياة"],["What's your perfect weekend?","كيف تقضي عطلة نهاية الأسبوع المثالية؟","LIFESTYLE","أسلوب حياة"],["What do you wish your friend understood about you?","ما الشيء الذي تتمنى أن يفهمه صديقك عنك؟","FRIENDSHIP","صداقة"]];
...
function draw(){let ar=currentLang==="ar";document.getElementById("kind").textContent=phase===1?(ar?"عنك":"ABOUT YOU"):(ar?"توقع صاحبك":"GUESS YOUR FRIEND");document.getElementById("num").textContent=n+1;document.getElementById("bar").style.width=(n+1)*10+"%";document.getElementById("q").textContent=ar?qs[n][1]:qs[n][0];document.getElementById("cat").textContent=ar?qs[n][3]:qs[n][2];document.getElementById("hint").textContent=phase===1?(ar?"جاوب بصراحة. صاحبك هيحاول يتوقعها بعدين.":"Answer honestly. Your friend will guess this later."):(ar?"إيه توقعك لإجابة صاحبك؟":"What do you think your friend answered?");document.getElementById("ans").value="";show("quiz")}
